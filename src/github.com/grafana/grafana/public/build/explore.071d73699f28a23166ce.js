...
/* harmony import */ var app_core_components_Picker_ResetStyles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! app/core/components/Picker/ResetStyles */ "./public/app/core/components/Picker/ResetStyles.tsx");
/* harmony import */ var app_core_components_Picker_PickerOption__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/core/components/Picker/PickerOption */ "./public/app/core/components/Picker/PickerOption.tsx");
/* harmony import */ var app_core_components_Picker_IndicatorsContainer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! app/core/components/Picker/IndicatorsContainer */ "./public/app/core/components/Picker/IndicatorsContainer.tsx");
/* harmony import */ var app_core_components_Picker_NoOptionsMessage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! app/core/components/Picker/NoOptionsMessage */ "./public/app/core/components/Picker/NoOptionsMessage.tsx");
/* harmony import */ var _ElapsedTime__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ElapsedTime */ "./public/app/features/explore/ElapsedTime.tsx");
/* harmony import */ var _QueryRows__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./QueryRows */ "./public/app/features/explore/QueryRows.tsx");
/* harmony import */ var _Graph__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Graph */ "./public/app/features/explore/Graph.tsx");
/* harmony import */ var _Logs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Logs */ "./public/app/features/explore/Logs.tsx");
/* harmony import */ var _Table__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Table */ "./public/app/features/explore/Table.tsx");
/* harmony import */ var _TimePicker__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./TimePicker */ "./public/app/features/explore/TimePicker.tsx");
/* harmony import */ var _utils_query__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./utils/query */ "./public/app/features/explore/utils/query.ts");
...
var Explore = /** @class */ (function (_super) {
    ...
    function Explore(props) {
        ...
        _this.onAddQueryRow = function (index) {
            ...
            _this.queryExpressions[index + 1] = '';
            var nextQueries = queries.slice(0, index + 1).concat([
                { query: '', key: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["generateQueryKey"])() }
        ...
        _this.onChangeQuery = function (value, index, override) {
            ...
            _this.queryExpressions[index] = value;
            // Replace query row on override
            if (override) {
                var queries = _this.state.queries;
                var nextQuery = {
                    key: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["generateQueryKey"])(index),
                    query: value,
                };
        ...
        _this.onClickClear = function () {
            ...
            _this.setState({
                ...
                logsResult: null,
                latency: 0,
                queries: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["ensureQueries"])(),
                queryErrors: [],
                queryHints: [],
                tableResult: null,
            }, _this.saveState);
        ...
        _this.onModifyQueries = function (action, index) {
            ...
            if (datasource && datasource.modifyQuery) {
                ...
                if (index === undefined) {
                    // Modify all queries
                    nextQueries = queries.map(function (q, i) { return ({
                        key: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["generateQueryKey"])(i),
                        query: datasource.modifyQuery(_this.queryExpressions[i], action),
                    }); });
                }
                else {
                    ...
                    nextQueries = queries.slice(0, index).concat([
                        {
                            key: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["generateQueryKey"])(index),
                            query: datasource.modifyQuery(_this.queryExpressions[index], action),
                        }
                    ], queries.slice(index + 1));
                }
                _this.queryExpressions = nextQueries.map(function (q) { return q.query; });
        ...
        if (splitState) {
            ...
            initialQueries = Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["ensureQueries"])(queries);
            _this.state = {
                datasource: null,
                datasourceError: null,
                ...
                queryErrors: [],
                queryHints: [],
                range: range || tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, app_core_utils_explore__WEBPACK_IMPORTED_MODULE_9__["DEFAULT_RANGE"]),
                requestOptions: null,
                showingGraph: true,
                showingLogs: true,
                showingTable: true,
        ...
        _this.queryExpressions = initialQueries.map(function (q) { return q.query; });
        return _this;
    }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        nextQueries = this.state.queries.map(function (q, i) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, q, { key: Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["generateQueryKey"])(i), query: _this.queryExpressions[i] })); });
                        this.setState({
    ...
    Explore.prototype.buildQueryOptions = function (targetOptions) {
        ...
        var targets = this.queryExpressions.map(function (q) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, targetOptions, { expr: q })); });
        return {
            interval: interval,
            range: range,
            targets: targets,
    ...
    Explore.prototype.runGraphQuery = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var datasource, queries, now, options, res, result, queryHints, latency, response_1, queryError;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        datasource = this.state.datasource;
                        queries = this.queryExpressions.slice();
                        if (!Object(_utils_query__WEBPACK_IMPORTED_MODULE_20__["hasQuery"])(queries)) {
                            return [2 /*return*/];
                        }
    ...
    Explore.prototype.runTableQuery = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var queries, datasource, now, options, res, tableModel, latency, response_2, queryError;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        queries = this.queryExpressions.slice();
    ...
    Explore.prototype.runLogsQuery = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var queries, datasource, now, options, res, logsData, latency, response_3, queryError;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        queries = this.queryExpressions.slice();
    ...
    Explore.prototype.render = function () {
        ...
        var selectedDatasource = datasource ? exploreDatasources.find(function (d) { return d.label === datasource.name; }) : undefined;
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: exploreClass, ref: this.getRef },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "navbar" },
                ...
                !datasourceMissing ? (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "navbar-buttons" },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_select__WEBPACK_IMPORTED_MODULE_3__["default"], { classNamePrefix: "gf-form-select-box", isMulti: false, isLoading: datasourceLoading, isClearable: false, className: "gf-form-input gf-form-input--form-dropdown datasource-picker", onChange: this.onChangeDatasource, options: exploreDatasources, styles: app_core_components_Picker_ResetStyles__WEBPACK_IMPORTED_MODULE_10__["default"], placeholder: "Select datasource", loadingMessage: function () { return 'Loading datasources...'; }, noOptionsMessage: function () { return 'No datasources found'; }, value: selectedDatasource, components: {
                            Option: app_core_components_Picker_PickerOption__WEBPACK_IMPORTED_MODULE_11__["default"],
                            IndicatorsContainer: app_core_components_Picker_IndicatorsContainer__WEBPACK_IMPORTED_MODULE_12__["default"],
                            NoOptionsMessage: app_core_components_Picker_NoOptionsMessage__WEBPACK_IMPORTED_MODULE_13__["default"],
                        } }))) : null,
                ...
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_TimePicker__WEBPACK_IMPORTED_MODULE_19__["default"], { range: range, onChangeTime: this.onChangeTime }),
                ...
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "navbar-buttons relative" },
                    ...
                    loading || latency ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ElapsedTime__WEBPACK_IMPORTED_MODULE_14__["default"], { time: latency, className: "text-info" }) : null)),
            ...
            datasource && !datasourceError ? (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-container" },
                ...
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("main", { className: "m-t-2" },
                    supportsGraph &&
                        showingGraph &&
                        graphResult && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Graph__WEBPACK_IMPORTED_MODULE_16__["default"], { data: graphResult, height: graphHeight, loading: loading, id: "explore-graph-" + position, options: requestOptions, split: split })),
                    supportsTable && showingTable ? (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "panel-container" },
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Table__WEBPACK_IMPORTED_MODULE_18__["default"], { data: tableResult, loading: loading, onClickCell: this.onClickTableCell }))) : null,
                    supportsLogs && showingLogs ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Logs__WEBPACK_IMPORTED_MODULE_17__["default"], { data: logsResult, loading: loading }) : null))) : null));
    };
    return Explore;
...
/* harmony import */ var _Legend__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Legend */ "./public/app/features/explore/Legend.tsx");
...
var Graph = /** @class */ (function (_super) {
    ...
    Graph.prototype.draw = function () {
        var _a = this.props, userOptions = _a.options, size = _a.size;
        ...
        if (!moment__WEBPACK_IMPORTED_MODULE_3___default.a.isMoment(from)) {
            from = app_core_utils_datemath__WEBPACK_IMPORTED_MODULE_7__["parse"](from, false);
        }
        if (!moment__WEBPACK_IMPORTED_MODULE_3___default.a.isMoment(to)) {
            to = app_core_utils_datemath__WEBPACK_IMPORTED_MODULE_7__["parse"](to, true);
        }
    ...
    Graph.prototype.render = function () {
        var _a = this.props, _b = _a.height, height = _b === void 0 ? '100px' : _b, _c = _a.id, id = _c === void 0 ? 'graph' : _c, _d = _a.loading, loading = _d === void 0 ? false : _d;
        var data = this.getGraphData();
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null,
            ...
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "panel-container" },
                ...
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Legend__WEBPACK_IMPORTED_MODULE_8__["default"], { data: data }))));
    };
    return Graph;
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: className + " logs" },
            hasData ? (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "logs-entries panel-container" }, data.rows.map(function (row) { return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], { key: row.key },
                ...
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_highlight_words__WEBPACK_IMPORTED_MODULE_2___default.a, { textToHighlight: row.entry, searchWords: row.searchWords, findChunks: app_core_utils_text__WEBPACK_IMPORTED_MODULE_3__["findHighlightChunksInText"], highlightClassName: "logs-row-match-highlight" })))); }))) : null,
...
var PromQueryField = /** @class */ (function (_super) {
    ...
    function PromQueryField(props, context) {
        ...
        _this.onReceiveMetrics = function () {
            var _a = _this.state, histogramMetrics = _a.histogramMetrics, metrics = _a.metrics, metricsByPrefix = _a.metricsByPrefix;
            if (!metrics) {
                return;
            }
    ...
    PromQueryField.prototype.getLabelTypeahead = function (_a) {
        ...
        if ((text && text.match(/^!?=~?/)) || lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes(wrapperClasses, 'attr-value')) {
            // Label values
    ...
    PromQueryField.prototype.fetchHistogramMetrics = function () {
        ...
        this.fetchSeriesLabels(HISTOGRAM_SELECTOR, true, function () {
            ...
            if (histogramSeries && histogramSeries['__name__']) {
                ...
                _this.setState({ histogramMetrics: histogramMetrics }, _this.onReceiveMetrics);
            }
        });
    };
    ...
    PromQueryField.prototype.render = function () {
        var _a = this.props, error = _a.error, hint = _a.hint, initialQuery = _a.initialQuery, supportsLogs = _a.supportsLogs;
        var _b = this.state, logLabelOptions = _b.logLabelOptions, metricsOptions = _b.metricsOptions, syntaxLoaded = _b.syntaxLoaded;
        return (react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", { className: "prom-query-field" },
            ...
            react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", { className: "prom-query-field-wrapper" },
                react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", { className: "slate-query-field-wrapper" },
                    react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_QueryField__WEBPACK_IMPORTED_MODULE_12__["default"], { additionalPlugins: this.plugins, cleanText: _utils_prometheus__WEBPACK_IMPORTED_MODULE_11__["cleanText"], initialValue: initialQuery, onTypeahead: this.onTypeahead, onWillApplySuggestion: willApplySuggestion, onValueChanged: this.onChangeQuery, placeholder: "Enter a PromQL query", portalOrigin: "prometheus", syntaxLoaded: syntaxLoaded })),
...
var QueryField = /** @class */ (function (_super) {
    ...
    function QueryField(props, context) {
        ...
        _this.handleTypeahead = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.debounce(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                ...
                if (onTypeahead && selection.anchorNode) {
                    ...
                    if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.isEqual(filteredSuggestions, this.state.suggestions)) {
        ...
        _this.renderMenu = function () {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Portal, { origin: portalOrigin },
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Typeahead__WEBPACK_IMPORTED_MODULE_8__["default"], { menuRef: _this.menuRef, selectedItem: selectedItem, onClickItem: _this.onClickMenu, prefix: typeaheadPrefix, groupedItems: suggestions })));
        };
        // Base plugins
...
var QueryRow = /** @class */ (function (_super) {
    ...
    QueryRow.prototype.render = function () {
        var _a = this.props, history = _a.history, query = _a.query, queryError = _a.queryError, queryHint = _a.queryHint, request = _a.request, supportsLogs = _a.supportsLogs;
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "query-row" },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "query-row-field" },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_PromQueryField__WEBPACK_IMPORTED_MODULE_2__["default"], { error: queryError, hint: queryHint, initialQuery: query, history: history, onClickHintFix: this.onClickHintFix, onPressEnter: this.onPressEnter, onQueryChange: this.onChangeQuery, request: request, supportsLogs: supportsLogs })),
...
var QueryRows = /** @class */ (function (_super) {
    ...
    QueryRows.prototype.render = function () {
        var _a = this.props, _b = _a.className, className = _b === void 0 ? '' : _b, queries = _a.queries, queryErrors = _a.queryErrors, queryHints = _a.queryHints, handlers = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["className", "queries", "queryErrors", "queryHints"]);
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: className }, queries.map(function (q, index) { return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(QueryRow, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ key: q.key, index: index, query: q.query, queryError: queryErrors[index], queryHint: queryHints[index] }, handlers))); })));
    };
    return QueryRows;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]));
...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_table__WEBPACK_IMPORTED_MODULE_3__["default"], { columns: columns, data: tableModel.rows, getTdProps: this.getCellProps, loading: loading, minRows: 0, noDataText: noDataText, resolveData: function (data) { return prepareRows(data, columnNames); }, showPagination: data }));
    };
    return Table;
}(react__WEBPACK_IMPORTED_MODULE_2__["PureComponent"]));
...
var TypeaheadItem = /** @class */ (function (_super) {
    ...
    TypeaheadItem.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", { ref: this.getRef, className: className, onClick: this.onClick },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_highlight_words__WEBPACK_IMPORTED_MODULE_2___default.a, { textToHighlight: label, searchWords: [prefix], highlightClassName: "typeahead-match" }),
    ...
    TypeaheadGroup.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", { className: "typeahead-group" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", { className: "typeahead-group__list" }, items.map(function (item) {
                return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TypeaheadItem, { key: item.label, onClickItem: onClickItem, isSelected: selected === item, item: item, prefix: prefix }));
            }))));
    };
...
var Typeahead = /** @class */ (function (_super) {
    ...
    Typeahead.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", { className: "typeahead", ref: menuRef }, groupedItems.map(function (g) { return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TypeaheadGroup, tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ key: g.label, onClickItem: onClickItem, prefix: prefix, selected: selectedItem }, g))); })));
    };
    return Typeahead;
}(react__WEBPACK_IMPORTED_MODULE_1___default.a.PureComponent));
...
function hasQuery(queries) {
    return queries.some(function (q) { return Boolean(q); });
}
...
//# sourceMappingURL=explore.071d73699f28a23166ce.js.map
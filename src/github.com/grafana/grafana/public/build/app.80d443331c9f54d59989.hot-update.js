...
var InfluxQueryCtrl = /** @class */ (function (_super) {
    ...
    InfluxQueryCtrl.prototype.getFields = function () {
        ...
        if (this.templateSrv.variableExists("$Sensor3")) {
            this.templateSrv.getVarFromIndex()["Sensor2"].query = "eef44, wewew8";
            this.variableSrv.updateOptions(this.templateSrv.getVarFromIndex()["Sensor3"]);
            ...
            console.log(this.templateSrv.getVarFromIndex()["Sensor3"]);
        }
    };
...
//# sourceMappingURL=app.80d443331c9f54d59989.hot-update.js.map
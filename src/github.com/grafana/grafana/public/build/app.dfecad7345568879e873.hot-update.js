...
var InfluxQueryCtrl = /** @class */ (function (_super) {
    ...
    InfluxQueryCtrl.prototype.getFields = function () {
        ...
        if (this.templateSrv.variableExists("$Sensor4")) {
            this.templateSrv.getVarFromIndex()["Sensor4"].query = "eef44, wewew8";
            this.variableSrv.updateOptions(this.templateSrv.getVarFromIndex()["Sensor4"]);
            console.log(this.templateSrv.getVarFromIndex()["Sensor4"]);
        }
        else {
            variable = this.variableSrv.createVariableFromModel({ type: "custom" });
            variable.name = "Sensor4";
...
//# sourceMappingURL=app.dfecad7345568879e873.hot-update.js.map
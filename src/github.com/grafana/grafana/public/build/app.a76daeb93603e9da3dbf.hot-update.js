...
var InfluxQueryCtrl = /** @class */ (function (_super) {
    ...
    InfluxQueryCtrl.prototype.getFields = function () {
        ...
        if (this.templateSrv.variableExists("$Sensor2")) {
            ...
            this.variableSrv.addVariable(this.templateSrv.getVarFromIndex()["Sensor"]);
            ...
            variable.query = "eef, ref, wew777ew";
...
//# sourceMappingURL=app.a76daeb93603e9da3dbf.hot-update.js.map